...
def main(req: func.HttpRequest, docs: func.Out[func.Document]) -> func.HttpResponse:
    ...
    if text:
        ...
        return func.HttpResponse(f"Hello. This CreateKoreksi function executed successfully.\n{json.dumps(ret)}")
    else:
        return func.HttpResponse(
             "This HTTP triggered function executed successfully. Pass a text in the query string or in the request body for a text analytics.",
             status_code=200
        )
